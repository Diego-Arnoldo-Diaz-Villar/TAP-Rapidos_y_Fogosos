...
def iniciar_juego():
    ...
    ventana_juego.title("¡A JUGAR!")
    ventana_juego.geometry("800x600")
    ventana_juego.configure(bg="#1a1a1a")
    ventana_juego.resizable(False, False)

    imagen = Image.open("/Users/edsontalamantes/Desktop/Rapido Y Fogoso/roadfighter.png")
    imagen = imagen.resize((800, 600), Image.ANTIALIAS)  # Ajustar el tamaño de la imagen
